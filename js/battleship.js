var view = {
    ...
    displayHit: function (location) {
        var shipLocation = document.getElementById(location);
        shipLocation.classList.add("hit");
    },

    displayMiss: function (location) {
        var emptyLocation = document.getElementById(location);
        emptyLocation.classList.add("miss");
    }
}
...
var model = {
    ...
    fire: function (guess) {
        for (var i = 0; i < this.numShips; i++) {
            ...
            if (index >= 0) {
                ship.hits[index] = "hit";  // Проверка на попадание
